...
This guide is for Pelican installs running directly on the host, no Docker, no containers. If you're using Docker, use the [Dockerized](./docker.md) guide instead.
