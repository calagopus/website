...
=== APT / RPM
See the [Package Manager Installation](./pkgmanager.md) guide. Install directly from the Calagopus repository using APT (Debian/Ubuntu) or RPM (RHEL/Fedora). Note that this method does not support extensions.
