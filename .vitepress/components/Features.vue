...
const features = [
  ...
  },
  {
    ...
    link: {
      href: '/docs/panel/installation/docker',
...
<template>
  ...
  >
    <h2 id="features-heading" class="section-heading">Why Calagopus?</h2>
    <div class="custom-features-grid">
      ...
      >
        ...
        <a
          ...
          class="link"
        >
          <FontAwesomeIcon :icon="faCircleInfo" class="fa-icon" aria-hidden="true" />
          {{ feature.link.label }}
        </a>
      </article>
    </div>
